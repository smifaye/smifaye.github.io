...
## Content model
I talk extensively about [my work on the content model](future-proofing-our-content) but one bit I didn't mention there was how important it was to get the wording right for the UX content. The way a content design interacts with the content model is in the CMS. A well designed content model shouldn't need much explanation or training on how to use.

////// Targeted content instead of revealables
////// Page, advice collection
