...
## Collaboration
The nature of our project requires all disciplines to work with each other. When I [designed the new content model](future-proofing-our-content) I didn't work on this in isolation. It required lots of close work with back-end developers, user researchers and other content designers.

This is a part of my job I enjoy. Working together with another member of the team to tackle a challenge means we can share the success and pain.
